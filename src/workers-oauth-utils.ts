...
<head>
	...
	<title>Authorize OneHealth_MCP</title>
	<style>
		* {
			margin: 0;
			padding: 0;
	...
	<div class="container">
		<div class="header">
			<div class="brand">
				...
				<div>
					<strong>OneHealth_MCP</strong>
					<span>Private health context for AI agents</span>
				</div>
			</div>
			<h1>Connect OneHealth_MCP to Claude.</h1>
			<p>Claude is asking permission to use your OneHealth MCP endpoint. Approving lets Claude read the fitness sources you connect, then answer questions using your workouts, nutrition, sleep, recovery, and activity context.</p>
		</div>
		...
		<div class="panel">
			...
			<div class="permissions">
				...
				<div class="permission-item">
					...
					<p>Use your connected Hevy, Strava, Cronometer, Intervals.icu, Fitbit, and Google Fit data through OneHealth_MCP.</p>
				</div>
				<div class="permission-item">
					<p><strong>Call OneHealth MCP tools</strong></p>
				...
				<div class="permission-item">
					...
					<p>Claude receives MCP tool results, not your raw API keys or passwords. Stored credentials remain encrypted in your OneHealth account.</p>
				</div>
			</div>
