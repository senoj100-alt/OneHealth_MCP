...
export type OneHealthServiceId =
	| "hevy"
	| "strava"
	| "cronometer"
	| "intervals_icu"
...
function idFor(userId: string, serviceId: OneHealthServiceId): string {
